...
class WifiSettings:
    def __init__(self, frame, startup):
        self.frame = frame
        self.startup = startup
        self.frame.config(bg='#64edb4')
        self.setup_ui()

    def setup_ui(self):
        # Simple WiFi settings UI (placeholder)
        label = tk.Label(self.frame, text="WiFi Settings", font=Font, fg='black', bg='#64edb4')
        label.place(x=400, y=200)
        home_button = tk.Button(self.frame, text="Back to Home", font=Font, 
                               command=self.back_to_home, bg='#a0f291', width=15)
        home_button.place(x=400, y=300)

    def back_to_home(self):
        self.hide()
        self.startup.ShowMainScreen()

    def Load(self):
        pass  # No initialization needed beyond setup_ui
...
class StatrupClass:
    ...
    def __init__(self) -> None:
        ...
        def handleStart():
            ...
            globaladc.buzzer_1()
            MsgBox = messagebox.askquestion('Smoking Status', 'Do you have habit of\nSmoking', icon='question')
            if MsgBox == 'yes':
    ...
    def main(self):
        ...
        # Run this while loading 1st blank screen
    ...
    # Initial workflow show Main Screen
